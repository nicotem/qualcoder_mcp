...
class TestThePublishedSchemaBudget:
    ...
    FULL_MEASURED = 164_109          # 72 tools, Python 3.13.5, mcp 1.30.0
    CORE_MEASURED = 56_317           # 21 tools, same environment
    FULL_MEASURED_310 = 172_461      # the same tree on Python 3.11.13
