...
# v0.13 release): one row per Here line, as (entry, path, names...). An
...
NOTICE_HERE = (
    ...
    (47, "tests/test_v012_palette_idempotent.py", "UPSTREAM_COLORS",
     "TestPaletteParity.test_palette_identical_to_pinned_upstream"),
    (48, "tests/test_v012_palette_idempotent.py", "upstream_color_matcher"),
    (49, "tests/test_v012_palette_idempotent.py",
     "TestPaletteParity.test_named_cases"),
    (50, "tests/test_v012_pseudonymise_engine.py", "MasterEditWalk"),
    (51, "tests/test_v012_pseudonymise_engine.py", "master_boundary_spans",
    ...
    (53, "tests/test_v17_support.py", "replay_master_open_repair"),
    (53, "tests/test_qa_v17_gate_core.py", "master_repair_rowcount"),
    (54, "tests/test_qa_memo_codebook_gotchas.py",
    ...
    (55, "tests/test_qa_memo_codebook_gotchas.py", "_qualcoder_merge"),
    (56, "tests/test_qa_v17_gate_core.py",
    ...
    (58, "tests/test_qa_memo_codebook_gotchas.py",
    ...
    (59, "tests/test_qc40_visibility.py", "_VIEW_DDL",
     "_VISIBILITY_COLUMN_DDL", "_BROKEN_VIEWS"),
    (60, "tests/test_v012_ai_coder_setting.py",
     "TestUpstreamParity.CODER_NAMES_DDL",
     "TestUpstreamParity.test_a_name_absent_from_coder_names_is_visible"),
    (61, "tests/test_v012_pseudonymise_tool.py", "SCHEMA", "VISIBILITY_COLUMN",
     "VISIBILITY_VIEWS"),
    (62, "tests/test_v17_support.py", "BASE_SCHEMA", "_migrate_v15",
     "_migrate_v16", "_migrate_v17"),
    (63, "tests/track6_build.py", "DDL"),
    (64, "tests/conftest.py"),
    (64, "tests/test_database_reads.py"),
    (64, "tests/test_database_writes.py"),
    (64, "tests/test_fault_injection.py"),
    (64, "tests/test_qa_toolset_gate.py"),
    (64, "tests/test_toolset_modes.py"),
    (64, "tests/test_transport.py"),
    (64, "tests/track5_helpers.py"),
    (64, "tests/test_v17_support.py"),
    (64, "tests/test_v013_rename_tools.py"),
    (64, "scripts/create_test_project.py"),
    (65, "tests/test_v012_pseudonymise_tool.py"),
    (65, "tests/test_v012_duplicate_inserts.py"),
    (65, "tests/test_fix_wave.py"),
    (65, "tests/test_qa_round2_regressions.py"),
    (65, "tests/test_v013_names_left_in_text.py"),
    (65, "tests/test_v013_one_file_per_call.py"),
    (65, "tests/test_v013_rename_tools.py"),
    (65, "tests/test_v013_rename_backups.py"),
    (65, "tests/test_v08_attributes.py"),
    (65, "tests/test_qa_v08_d1d2_attack.py"),
    (66, "tests/test_qc40_backup_parity.py",
     "TestIgnoreSetPinned.test_qualcoder_set_is_byte_exact_with_upstream"),
    (66, "tests/test_qc40_memo_privacy.py",
     "TestMergeCategoryProvenance.test_source_memo_carried_with_parity_recipe"),
    (67, "tests/test_v013_rename_tools.py", "upstream_manage_cases"),
    (68, "tests/test_v013_rename_tools.py", "upstream_rename_entry"),
    (69, "tests/test_v013_rename_tools.py", "_save_display", "_save_filter",
     "QUALCODER_DISPLAYS", "QUALCODER_FILTERS"),
    (70, "tests/test_v012_pseudonymise_tool.py", "upstream_apply",
     "TestSavingTheMappingIntoPseudonymsJson.test_qualcoder_applying_the_written_file_gives_this_runs_text"),
    (71, "tests/test_v012_pseudonymise_tool.py",
     "TestSavingTheMappingIntoPseudonymsJson.test_pseudonyms_json_is_byte_identical_to_qualcoders_own_write"),
    (72, "QUALCODER_IMPORT_CAPABILITIES.md"),
    (73, "QUALCODER_IMPORT_CAPABILITIES.md"),
    (74, "RESEARCH_SUMMARY.md"),
)
