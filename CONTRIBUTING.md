...
Most of the items NOTICE lists were copied before this rule was made;
some of them could be written afresh, and each is kept as it is until
its code is next changed.
