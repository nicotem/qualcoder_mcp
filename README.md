...
- 🎯 Quote-anchored writes with a fuzzy fallback, and a persistent change
  journal with undo
- 🕵️ Rewriting the public part of memos under a separate switch
